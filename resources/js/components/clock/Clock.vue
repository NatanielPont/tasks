...
export default {
  ...
  methods: {
    ...
    drawTime (ctx, radius) {
      ...
      this.drawHand(ctx, minute, radius * 0.7, radius * 0.07)
      // second
      second = (second * Math.PI / 30)
      // console.log(second)
      this.drawHand(ctx, second, radius * 0.6, radius * 0.02)
      millis = (millis * Math.PI / 30000) + second
      console.log(millis)
      this.drawHand(ctx, millis, radius * 0.6, radius * 0.02)
    },
  ...
  mounted () {
    ...
    var radius = this.canvas.height / 2 - 20
    radius = radius * 0.90
