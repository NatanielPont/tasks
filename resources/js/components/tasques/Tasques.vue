<template>
    <span>
        <tasks-list v-show="dataTasks.length>0" @change="killEventBus" :users="users" :uri="uri" :tasks="dataTasks" :tags="tags"></tasks-list>
         <v-container grid-list-md text-xs-center v-show="dataTasks.length==0">
        <v-layout row wrap>
        ...
        <!--<no-data-component v-show="dataTasks.length==0" @change="killEventBus" :users="users" :uri="uri" :tags="tags"></no-data-component>-->
